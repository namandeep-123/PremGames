...
const new_games = `games?dates=${currentDay},${upcomingYear}&key=${API_KEY}&ordering=-added&page_size=10`;
const upcoming_games = `games?dates=${lastYear},${currentDay}&key=${API_KEY}&ordering=-releasing&page_size=10`;
